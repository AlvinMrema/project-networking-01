...
try {  
    ...
    $url = "https://demos.stemloyola.org/coder/ACCOUNT/api/get-regional-cities.php?region=$region"; // TODO: Replace ACCOUNT with your account username
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <!-- Search -->
        <form action="/coder/ACCOUNT/cities/search.php">   <?php // TODO: Replace ACCOUNT with your account username ?>
